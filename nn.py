...
from draw_results import draw_far_frr, draw_classes_roc_curve, plot_result_nn, get_info_readme, plot_confusion_metrics, \
    hipotese_tests, calculate_far_frr_eer, draw_system_t_roc_curve, draw_system_roc_curve
...
history = model.fit(expand_dims(X_train, axis=-1), y_train, validation_data=(X_valid, y_valid), epochs=27,
...
# 1
copyfile(models_directory + '\\classes_roc_curve_' + file_title + '.png', graph_directory + 'classes\\' + file_title + '.png')
# 2
...
# 5
copyfile(models_directory + '\\modified_roc_' + file_title + '.png', graph_directory + 'modified_roc\\' + file_title + '.png')
# 6
copyfile(models_directory + '\\far_frr_' + file_title + '.png', graph_directory + 'far_frr\\' + file_title + '.png')

copyfile(models_directory + '\\classes_micro_macro_roc_curve_' + file_title + '.png', graph_directory + 'marco_mircro_classes\\' + file_title + '.png')
